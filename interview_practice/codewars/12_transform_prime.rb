...
inserted in a list, so that sum of all elements of 
...
Explanation:
Since , the sum of the list's elements equal to (6) , t
he minimum number to be inserted to transform the sum to prime number is (1),
...
Data structure:
  starting with array of integers
  hello this is stephen and i am typing in viscodefff
